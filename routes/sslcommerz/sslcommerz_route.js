...
const success_payment_controller = require('../../controllers/sslcommerz/success_payment_controller');
...
sslcommerz_route.post('/payment/success', success_payment_controller);
